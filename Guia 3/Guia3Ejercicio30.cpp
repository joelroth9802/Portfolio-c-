...
int main(int argc, char *argv[]) {
	...
	float cont, cont2, acum1000, acum500, acum200, acum100, cajFalt;
	float total1000, total500, total200, total100;
	float totalrep1000, totalrep500, totalrep200, totalrep100;
	string nomSucur;
	cout << "Ingrese la cantidad de sucursales del banco: ";
	cin >> cantSucur;
	cont = 0; cajFalt = 0; totalrep1000 = 0; total500 = 0; totalrep200 = 0; totalrep100 = 0;
	while (cont < cantSucur)
	{
		cont++;
		cout << "Sucursal " << cont << ":" << endl;
		cin.ignore();
		cout << "Ingrese nombre de la sucursal: ";
		getline(cin, nomSucur);
		cout << "Ingrese la cantidad de cajeros automáticos: ";
		cin >> cantCaje;
		cont2 = 0; acum1000 = 0; acum500 = 0; acum200 = 0; acum100 = 0;
		while (cont2 < cantCaje)
		{
			cont2++;
			cout << "Cajero " << cont2 << ":" << endl;
